...
Values		('1','Cadeira','Finora','524632','Cadeira de Escritorio','532459','1'),
			...
			('4','Caixa Ambiente','Bravox','Caixa de som para Ambiente Escolar','978649','386818','1'),
			('2','Teclado & Mouse','Logitech','Teclado & Mouse MK120','197529','381298','1'),
			('5','Projetor HDMI','Acer','Projetor Acer 400 Lumens','949296','675255','1'),
			('2','Teclado & Mouse Sem Fio','Multilaser','Teclado e mouse Wireless','895967','833798','0');
Go
